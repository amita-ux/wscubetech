	...
	class TSSProField {
		...
		private function image() {
			...
			if ( $id = absint( $value ) ) {
				...
				$img  = "<img src='{$aImg[0]}' >"; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
				$c    = '';
			} else {
				$aImg = TSSPro()->placeholder_img_src();
				$img  = "<img src='{$aImg}' >"; // phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
			}
